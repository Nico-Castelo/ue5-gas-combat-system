...
{	
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_DeflectWindow);
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Montage_KnockdownLoop_Begin);
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Input_BlockPressed);
}
